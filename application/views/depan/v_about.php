            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url('');?>" class="navbar-brand nav-brand2"><img class="img img-responsive" Height="70px;" width="200px;" src="<?php echo base_url().'theme/images/Sukapura4.JPG'?>"></a>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/Sukapura1.jpg'?>" alt="First slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1 style="color:orange">SMK SUKAPURA Kab Tasikmalaya</h1>
                            <h1 style="color:red">SMK Kreaftif &amp; Inovatif</h1>
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/Angklung.jpg'?>" alt="Second slide">
                    <div class="carousel-caption d-md-block">
                        <!-- <div class="slider_title">
                            <h1>Guru Bekualitas Tinggi</h1>
                            <h4>SEKOLAH UNTUK ANAK PINTAR<br> Itulah kenapa kami mendatangkan guru-guru <br>terbaik dari berbagai penjuru.</h4>
                            <div class="slider-btn">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/KI.jpg'?>" alt="Third slide">
                    <div class="carousel-caption d-md-block">
                        <!-- <div class="slider_title">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="col-md-4">
                    <img src="<?php echo base_url().'theme/images/BapakOzan.jpg'?>" class="img-fluid" alt="#">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-md-3">
                        <div class="foot-logo">
                            <a href="<?php echo site_url();?>">
                                <img src="<?php echo base_url().'theme/images/LOGOSKPR.jpg'?>" class="img-fluid" alt="footer_logo">
                            </a>
